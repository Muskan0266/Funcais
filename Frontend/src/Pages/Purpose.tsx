...
const Purpose = () => {
  ...
  const arr: PurposeCard[] = [
    {
      id: 0,
      icon: "travel",
      label: "Travel",
      color: "#F08787",
      text: "text-2xl md:text-7xl",
    ...
    },
    {
      ...
      label: "Community",
      color: "#FAEAB1",
      text: "text-2xl md:text-6xl",
      margin: "ml-25 md:ml-46",
    },
    {
      id: 4,
      icon: "pending",
